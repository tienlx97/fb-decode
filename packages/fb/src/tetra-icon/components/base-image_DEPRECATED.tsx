...
import coerceImageishSprited from '@fb/tetra-icon/utils/coerce-imageish-sprited'
import coerceImageishURL from '@fb/tetra-icon/utils/coerce-imageish-url'
import { processSpritedImagesForSSRPreload } from '@fb/tetra-icon/utils/comet-ssr-background-image-utils'
import React, {
  CSSProperties,
  forwardRef,
  useEffect,
